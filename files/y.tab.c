...
{
       0,    47,    47,    48,    52,    57,    60,    66,    67,    68,
      72,    73,    81,    85,    86,    87,    99
};
#endif
...
static const char *const yytname[] =
{
  ...
  "INTEGER", "FLOAT", "ADD", "SUB", "MUL", "DIV", "ASSIGN", "SEMICOLON",
  "LPAREN", "RPAREN", "PRINT", "$accept", "program", "statement",
...
{
     -10,     0,   -10,    -9,    -3,     1,   -10,   -10,     1,   -10,
     -10,   -10,     1,     5,    17,   -10,    11,     2,     1,     1,
     -10,     1,     1,   -10,   -10,    17,    17,   -10,   -10
};
...
{
       2,     0,     1,     0,     0,     0,     3,     6,     0,    15,
      13,    14,     0,     0,     9,    12,     0,     0,     0,     0,
       5,     0,     0,     4,    16,     7,     8,    10,    11
};
...
{
       2,     3,     7,     4,     9,    10,    11,     8,    18,    19,
       0,    18,    19,    12,     5,    24,    20,    18,    19,     0,
      16,     0,    23,     0,    17,    21,    22,    25,    26,    27,
      28
};

static const yytype_int8 yycheck[] =
{
       0,     1,    11,     3,     3,     4,     5,    10,     6,     7,
      -1,     6,     7,    12,    14,    13,    11,     6,     7,    -1,
       8,    -1,    11,    -1,    12,     8,     9,    18,    19,    21,
      22
};
...
{
       0,    16,     0,     1,     3,    14,    17,    11,    10,     3,
       4,     5,    12,    18,    19,    20,    18,    18,     6,     7,
      11,     8,     9,    11,    13,    19,    19,    20,    20
};
...
#line 52 "parser.y"
                                           {
        insert((yyvsp[-3].string), (yyvsp[-1].float_val));
        printf("%s = %f\n", (yyvsp[-3].string), (yyvsp[-1].float_val));
        free((yyvsp[-3].string));
    }
#line 1188 "y.tab.c"
    break;

  case 5: /* statement: PRINT expression SEMICOLON  */
#line 57 "parser.y"
                                 {
        printf("Resultado: %f\n", (yyvsp[-1].float_val));
    }
...
#line 1204 "y.tab.c"
  ...
  case 7: /* expression: expression ADD term  */
#line 66 "parser.y"
                        { (yyval.float_val) = (yyvsp[-2].float_val) + (yyvsp[0].float_val); }
#line 1210 "y.tab.c"
    break;

  case 8: /* expression: expression SUB term  */
#line 67 "parser.y"
                          { (yyval.float_val) = (yyvsp[-2].float_val) - (yyvsp[0].float_val); }
#line 1216 "y.tab.c"
    break;
...
#line 87 "parser.y"
                 {
        struct symbol *s = lookup((yyvsp[0].string));
        if (s == NULL) {
            char msg[100];
            sprintf(msg, "Variable no definida: %s", (yyvsp[0].string));
            yyerror(msg);
            (yyval.float_val) = 0;
        } else {
            (yyval.float_val) = s->value;
        }
        free((yyvsp[0].string));
    }
#line 1276 "y.tab.c"
